...
LIGHT = "#E8EEF2"
DISPLAY_LABELS = {
    "Matched1": "Matched 1", "Matched2": "Matched 2",
    "Matched3": "Matched 3", "Matched4": "Matched 4",
    "Broader1": "Broader 1", "Broader2": "Broader 2",
    "Broader3": "Broader 3",
}
...
def figure_gameplay_forest(stats: dict) -> None:
    ...
    order = ["Matched1", "Matched2", "Matched3", "Matched4",
    ...
    for index, ((label, result), ypos) in enumerate(zip(rows, y, strict=True)):
        ...
        marker = "D" if label == "Equal-weight overall" else ("s" if label in {"Matched1", "Matched2", "Matched3", "Matched4"} else "o")
