...
- The official NeurIPS BibTeX export for *Deep Sets* leaves the page field empty, but the official NeurIPS `Metadata.json` record supplies pages 3391--3401; that primary-record range is used here.
