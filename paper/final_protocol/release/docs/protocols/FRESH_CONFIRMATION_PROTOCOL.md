...
`restricted/path::sha256_path`: sorted relative file names
and file digests, excluding `__pycache__` directories and `.pyc` files.

| Role | Repository path | Frozen digest |
|---|---|---|
| Candidate (intervention) tree | `restricted/path` | `83489e0c80c631763c65375d2a7a34d28d6aa9fbb1d11e89d130c83b1e27f1c0` |
| Candidate archive | `restricted/path` | `0734b60c089eea9c2e40550b8e9c6dc3983957210794ba245c4c00bd9d4e7096` |
...
| Control (control) tree | `restricted/path` | `13426288358d597ead809e45c364c7f7b9274a6eebf55ddd942142e3326535c3` |
| Control archive | `restricted/path` | `a44b676f5ca135747b5d4d6923c7fb350a66369d188315b6ac0f291d23ca69e7` |
...
| Seeded evaluation engine | `restricted/path` | `867e3f9bb87e0b48889a44b5d4b04f5d2d434b2a0788d1b2bcfe0caebcb5ab78` |
| Production engine, integrity sentinel only | `restricted/path` | `7a157f045d333f99d1996d49c12bdbdd148072a619af246385c7295518776e30` |
| Paired runner | `restricted/path` | `fa60021b0906401aeb2c7c33e0f65f586eff256d83d689d688a86a40480e1341` |

The intervention package and raw earlier evaluation files entered history at commit
...
|---|---|---|---|---:|
| `deterministic-1` | `restricted/path` | `0c15b56adf3b09c654505a152309fdc9f8401579a495da714347d98ae735003c` | restricted-team | 202608230000 |
| `deterministic-2` | `restricted/path` | `7db753d6610930d8bd9694b4b9bece5ac48733b825422a3e399c18077b55e64e` | restricted-team | 202608231000 |
| `deterministic-3` | `restricted/path` | `8a06ebab47cc60ed981dfada85972eb8a62e732e349f01c2a3085262079f06e8` | restricted-team | 202608232000 |
| `deterministic-4` | `restricted/path` | `30e45955b67893514c8ee077cac15d46fc207efe781cbce1b94242defda4cbdc` | restricted-team | 202608233000 |
| `timed-search-A` | `restricted/path` | `1b73779da7dcc93c8f121090bb0f1ae2d9b10b798ca4c70447b0ce1d6d01c0db` | Other | 202608234000 |
| `timed-search-B` | `restricted/path` | `076ae8de12d2d6c4a170b47b2d2f9cf538c1d318a05bb2e81f13da9be2cd2026` | Other | 202608235000 |
| `deterministic-5` | `restricted/path` | `5d44338891094988ca15f0c26d5187316549facd64a7bfbac04aa0048424e8c7` | Other | 202608236000 |

For deterministic-5, the environment is frozen to `NO_SEARCH=1`. All other opponent
...
- eight workers for deterministic-1, deterministic-2, deterministic-3, deterministic-4, and deterministic-5, and four
  workers for timed-search-A and timed-search-B.
...
`d_ci = I(intervention wins) - I(C0 wins)`.
...
4. restricted-team-family and Other-family equal-policy aggregates;
