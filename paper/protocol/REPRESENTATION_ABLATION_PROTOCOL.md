...
| C3 | historical blind v2 | same training as EXP23 | missing cell, to be created by `paper/scripts/train_blind_ablation.py` |
| C4 | identity-aware v2 | EXP23 trained heads | EXP23 tree `83489e0c80c631763c65375d2a7a34d28d6aa9fbb1d11e89d130c83b1e27f1c0`; model `cefe61189bc6f4e316212b19c99450e4b91ff1e5493f4467a95041c30fd96984` |
...
`artifacts/final_sprint/identity_train/merged_decisions.jsonl.gz`, SHA-256
...
Training invokes the same `train_candidate` implementation and realized EXP23
