...
|---:|---|---|---|
| 0 | B0 | `0c15b56adf3b09c654505a152309fdc9f8401579a495da714347d98ae735003c` | `{}` |
| 1 | d842-runtime | `7db753d6610930d8bd9694b4b9bece5ac48733b825422a3e399c18077b55e64e` | `{}` |
| 2 | master-v1 | `8a06ebab47cc60ed981dfada85972eb8a62e732e349f01c2a3085262079f06e8` | `{}` |
| 3 | replay-refresh | `30e45955b67893514c8ee077cac15d46fc207efe781cbce1b94242defda4cbdc` | `{}` |
| 4 | Alakazam-no-search | `5d44338891094988ca15f0c26d5187316549facd64a7bfbac04aa0048424e8c7` | `{"NO_SEARCH":"1"}` |

The timed-search diagnostic population contains Starmie
...
The stress test uses C1 only and `i=0,...,49` for both orders.  Starmie has base
seed `2026092700`; Dipplin has base seed `2026093700`.  Each opponent/order/seed
...
localization; the public package contains digests, first-divergence positions
