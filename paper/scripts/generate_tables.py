...
def main() -> int:
    ...
    ablation_lines = [
        "% Auto-generated by paper/scripts/generate_tables.py; do not edit.",
        r"\begin{table*}",
        r"\caption{Matched four-cell ablation contrasts over 2,800 common seed-condition units. Effects are percentage-point win differences; intervals use the prospectively specified paired within-cell bootstrap.}",
