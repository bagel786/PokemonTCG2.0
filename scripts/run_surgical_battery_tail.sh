...
run s_dip_ab_d1 "$D1" 40 2026081697 '{"PTCG_TARGET_ROUTE":"force_dipplin","PTCG_SURGICAL":"dip_a,dip_b"}'
run s_dip_ab_d0 "$D0" 40 2026081698 '{"PTCG_TARGET_ROUTE":"force_dipplin","PTCG_SURGICAL":"dip_a,dip_b"}'
run s_parity_b0_surg "$B0" 40 2026081699 '{"PTCG_SURGICAL":"dip_a,dip_b"}'
echo TAIL_DONE
